...
<!-- As of 2026-08-09T09:18:20+00:00. Re-run the generator after any schema change. -->
...
- '501' = New York NY (3304 upcoming)
- '803' = Los Angeles CA (2314 upcoming)
- '839' = Las Vegas NV (2188 upcoming)
- '602' = Chicago IL (1451 upcoming)
- '506' = Boston MA-Manchester NH (1312 upcoming)
- '807' = San Francisco-Oakland-San Jose CA (1172 upcoming)
- '751' = Denver CO (1167 upcoming)
- '504' = Philadelphia PA (967 upcoming)
- '659' = Nashville TN (948 upcoming)
- '524' = Atlanta GA (902 upcoming)
- '753' = Phoenix AZ (810 upcoming)
- '819' = Seattle-Tacoma WA (793 upcoming)

## Tables

### fact_event_demand (2105530 rows, latest snapshot_date 2026-08-08)
...
### bridge_event_artist (72468 rows)
...
### fact_ticketmaster (2105530 rows, latest snapshot_date 2026-08-08)
...
### fact_trends (1072470 rows, latest snapshot_date 2026-08-08)
...
### fact_trends_daily (1720190 rows, latest snapshot_date 2026-08-08)
...
### fact_youtube (30160 rows, latest snapshot_date 2026-08-08)
...
### forecast_event_price (444422 rows)
