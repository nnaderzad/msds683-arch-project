...
Run (repo root, music-demand env, `bq` authed for the project):
    python eda/profile_schema.py
    python eda/profile_schema.py --project data-architecture-498123

Writes eda/output/schema_profile.csv (tidy long) + schema_profile.md
...
from _common import DEFAULT_DATASET, DEFAULT_PROJECT, bq_rows, fq  # noqa: E402
...
def write_outputs(records: list[dict[str, str]]) -> None:
    ...
    lines = [
        ...
        "",
        f"_Generated by `eda/profile_schema.py`, as of {as_of} "
